...
login_data = {
    "username": "hhmairac", # đổi thành username acc mcserver vào đây
    "email": "", # hoặc dùng mail để mail thì thôi username 
    "password": {
        "value": "17062009", # password điền vào 
        "repeat": ""
    }
}
sub_url = "https://www.mcserverhost.com/api/servers/f4a3b3d7/subscription" # dán vào đây 
def run_automation():
